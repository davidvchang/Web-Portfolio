        ...
        <div className='w-[90%] flex items-center justify-around'>
            <div className='flex flex-col'>
                ...
                <div className='flex pt-10 items-center gap-8'>
                    <a href="https://drive.google.com/file/d/1YAkwZtXxrJ_fO1OVyi9_shz-eEe8-XJK/view?usp=sharing" target='_blank' className='w-fit h-fit px-12 py-3 rounded-full font-medium bg-principal-color/80 hover:bg-green-700 hover:transition duration-300'>Ver CV</a>
